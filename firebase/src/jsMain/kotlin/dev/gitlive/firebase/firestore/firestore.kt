...
actual val Firebase.firestore get() =
    rethrow { dev.gitlive.firebase.common.firestore; FirebaseFirestore(firebase.firestore()) }

actual fun Firebase.firestore(app: FirebaseApp) =
    rethrow { dev.gitlive.firebase.common.firestore; FirebaseFirestore(firebase.app().firestore()) }
