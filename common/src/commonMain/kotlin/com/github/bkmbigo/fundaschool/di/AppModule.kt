...
import com.github.bkmbigo.fundaschool.data.square.repositories.PaymentRepositoryImpl
import com.github.bkmbigo.fundaschool.data.square.repositories.SubscriptionsRepositoryImpl
...
val commonModule = module {
    ...
    single<PaymentsAPI> { PaymentsAPI(get()) }
    single<SubscriptionsApi> { SubscriptionsApi(get()) }
}